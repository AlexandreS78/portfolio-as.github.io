 ...
 * JSDOC
 * Fichier : script.js
 * Projet : Portfolio Alexandre Simoes
 * Description : Comportements interactifs légers (navigation mobile accessible, smooth-scroll,
 * reveal on scroll, header scrolled state, lightbox pour galerie, validation formulaire).
 * Conventions : fonctions auto-exécutées pour isolation, utilisation d'IntersectionObserver
 * lorsque possible, respect de prefers-reduced-motion.
 */

/**
 * Menu mobile accessible
 * - toggle aria-expanded
 * - gère aria-hidden sur le nav principal
 */
 ...
 * - calcule offset pour header fixe
 * - ferme le menu mobile automatiquement sur navigation mobile
 */
...
/**
 * Reveal on scroll
 * - ajoute la classe .reveal aux éléments hors-viewport
 ...
 * - affichage d'une alerte de simulation
 */
